...
public class PvvGenerateRequest {
    ...
    @NotBlank(message = "CustomerPIN required, please provide a value.")
    @Pattern(regexp = DECIMAL_4TO12_DIGITS, message = "CustomerPIN required, must be numeric and 4 to 12 digits long.")
